...
## Project Structure
    ...
    ├── checkout_refactor_t_24386  # Django project configurations
...
1. Clone this repo and `cd checkout_refactor_t_24386`
...
2. Clone this repo and `cd checkout_refactor_t_24386`
